<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-array2326/1?page=3&difficulty[]=-2&difficulty[]=-1&status[]=unsolved&sortBy=submissions">Sum of Array</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer array <strong>Arr[] </strong>of size <strong>N</strong>. The task is to find sum of it.</span></p>
